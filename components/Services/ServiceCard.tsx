...
const ServiceCard: React.FC<ServiceCardProps> = (props) => {
  ...
  return (
    ...
    >
      <Card
        // isFooterBlurred
        className="relative w-full h-[300px] col-span-12 sm:col-span-7 overflow-hidden"
        radius="sm"
        shadow="md"
        isHoverable={true}
      >
        <CardHeader className="absolute z-10 top-1 flex-col items-start">
          ...
          <h1 className={`${primTitle({ size: "sm" })} bg-black/50`}>
            {title}
          </h1>
        ...
        <Image
          ...
          height={500}
          alt="service-image"
          className="z-0 w-full h-full object-cover brightness-75 stroke-slate-500 transition-transform duration-500 ease-in-out hover:scale-110"
          src={imageUrl}
        />
